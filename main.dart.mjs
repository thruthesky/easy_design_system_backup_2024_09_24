...
_1617: f => finalizeWrapper(f,x0 => dartInstance.exports._1617(f,x0)),
...
_1666: v => stringToDartString(v.toString()),
_1667: (d, digits) => stringToDartString(d.toFixed(digits)),
_1671: o => new WeakRef(o),
_1672: r => r.deref(),
_1677: Date.now,
...
_1690: s => stringToDartString(JSON.stringify(stringFromDartString(s))),
_1691: s => printToConsole(stringFromDartString(s)),
_1700: (o, t) => o instanceof t,
...
_1706: (handle) => clearTimeout(handle),
_1707: (ms, c) =>
          setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
_1708: (handle) => clearInterval(handle),
_1709: (c) =>
              queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
_1710: () => Date.now(),
_1742: (a, i) => a.push(i),
_1743: (a, i) => a.splice(i, 1)[0],
_1745: (a, l) => a.length = l,
_1746: a => a.pop(),
_1747: (a, i) => a.splice(i, 1),
_1749: (a, s) => a.join(s),
_1750: (a, s, e) => a.slice(s, e),
_1751: (a, s, e) => a.splice(s, e),
_1753: a => a.length,
_1755: (a, i) => a[i],
_1756: (a, i, v) => a[i] = v,
_1758: a => a.join(''),
...
_1817: s => stringToDartString(stringFromDartString(s).toUpperCase()),
_1818: s => stringToDartString(stringFromDartString(s).toLowerCase()),
_1820: (s, m) => {
          try {
...
_1825: x0 => x0.pop(),
_1829: (x0,x1,x2) => x0[x1] = x2,
_1831: o => o === undefined,
_1832: o => typeof o === 'boolean',
_1833: o => typeof o === 'number',
_1835: o => typeof o === 'string',
_1838: o => o instanceof Int8Array,
_1839: o => o instanceof Uint8Array,
_1840: o => o instanceof Uint8ClampedArray,
_1841: o => o instanceof Int16Array,
_1842: o => o instanceof Uint16Array,
_1843: o => o instanceof Int32Array,
_1844: o => o instanceof Uint32Array,
_1845: o => o instanceof Float32Array,
_1846: o => o instanceof Float64Array,
_1847: o => o instanceof ArrayBuffer,
_1848: o => o instanceof DataView,
_1849: o => o instanceof Array,
...
_1874: l => arrayFromDartList(Array, l),
_1875: stringFromDartString,
_1876: stringToDartString,
_1877: () => ({}),
_1878: () => [],
_1879: l => new Array(l),
_1880: () => globalThis,
...
_1900: x0 => x0.flags,
_1901: x0 => x0.multiline,
_1902: x0 => x0.ignoreCase,
_1903: x0 => x0.unicode,
_1904: x0 => x0.dotAll,
_1905: (x0,x1) => x0.lastIndex = x1,
_1907: (o, p) => o[p],
_1910: () => globalThis.document,
_1911: () => globalThis.window,
_1916: (x0,x1) => x0.height = x1,
_1918: (x0,x1) => x0.width = x1,
_1922: x0 => x0.head,
_1924: x0 => x0.classList,
_1929: (x0,x1) => x0.innerText = x1,
_1930: x0 => x0.style,
_1931: x0 => x0.sheet,
_1932: x0 => x0.matches,
_1933: x0 => x0.offsetX,
_1934: x0 => x0.offsetY,
_1935: x0 => x0.button,
_1936: x0 => x0.platform,
_1941: x0 => x0.navigator,
_1948: x0 => x0.status,
_1949: (x0,x1) => x0.responseType = x1,
_1951: x0 => x0.response,
_3750: () => globalThis.window,
_3830: x0 => x0.navigator,
_4311: x0 => x0.userAgent,
_14594: () => globalThis.window.flutterCanvasKit
    };
