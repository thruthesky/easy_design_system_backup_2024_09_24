...
_1652: v => stringToDartString(v.toString()),
_1653: (d, digits) => stringToDartString(d.toFixed(digits)),
_1657: o => new WeakRef(o),
_1658: r => r.deref(),
_1663: Date.now,
...
_1676: s => stringToDartString(JSON.stringify(stringFromDartString(s))),
_1677: s => printToConsole(stringFromDartString(s)),
...
_1692: (handle) => clearTimeout(handle),
_1693: (ms, c) =>
          setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
_1694: (handle) => clearInterval(handle),
_1695: (c) =>
              queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
_1696: () => Date.now(),
_1731: (a, i) => a.push(i),
_1732: (a, i) => a.splice(i, 1)[0],
_1734: (a, l) => a.length = l,
_1735: a => a.pop(),
_1736: (a, i) => a.splice(i, 1),
_1738: (a, s) => a.join(s),
_1739: (a, s, e) => a.slice(s, e),
_1740: (a, s, e) => a.splice(s, e),
_1742: a => a.length,
_1744: (a, i) => a[i],
_1745: (a, i, v) => a[i] = v,
_1747: a => a.join(''),
...
_1806: s => stringToDartString(stringFromDartString(s).toUpperCase()),
_1807: s => stringToDartString(stringFromDartString(s).toLowerCase()),
_1809: (s, m) => {
          try {
...
_1811: (x0,x1) => x0.test(x1),
_1812: (x0,x1) => x0.exec(x1),
_1813: (x0,x1) => x0.exec(x1),
_1814: x0 => x0.pop(),
_1818: (x0,x1,x2) => x0[x1] = x2,
_1820: o => o === undefined,
_1821: o => typeof o === 'boolean',
_1822: o => typeof o === 'number',
_1824: o => typeof o === 'string',
_1827: o => o instanceof Int8Array,
_1828: o => o instanceof Uint8Array,
_1829: o => o instanceof Uint8ClampedArray,
_1830: o => o instanceof Int16Array,
_1831: o => o instanceof Uint16Array,
_1832: o => o instanceof Int32Array,
_1833: o => o instanceof Uint32Array,
_1834: o => o instanceof Float32Array,
_1835: o => o instanceof Float64Array,
_1836: o => o instanceof ArrayBuffer,
_1837: o => o instanceof DataView,
_1838: o => o instanceof Array,
_1839: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
_1841: o => {
            const proto = Object.getPrototypeOf(o);
            return proto === Object.prototype || proto === null;
          },
_1842: o => o instanceof RegExp,
_1843: (l, r) => l === r,
_1844: o => o,
_1845: o => o,
_1846: o => o,
...
_1848: o => o.length,
_1851: (o, i) => o[i],
_1852: f => f.dartFunction,
_1853: l => arrayFromDartList(Int8Array, l),
_1854: l => arrayFromDartList(Uint8Array, l),
_1855: l => arrayFromDartList(Uint8ClampedArray, l),
_1856: l => arrayFromDartList(Int16Array, l),
_1857: l => arrayFromDartList(Uint16Array, l),
_1858: l => arrayFromDartList(Int32Array, l),
_1859: l => arrayFromDartList(Uint32Array, l),
_1860: l => arrayFromDartList(Float32Array, l),
_1861: l => arrayFromDartList(Float64Array, l),
_1862: (data, length) => {
...
_1864: stringFromDartString,
_1865: stringToDartString,
_1866: () => ({}),
_1867: () => [],
_1868: l => new Array(l),
_1869: () => globalThis,
...
_1885: (x0,x1) => x0[x1],
_1889: x0 => x0.flags,
_1890: x0 => x0.multiline,
_1891: x0 => x0.ignoreCase,
_1892: x0 => x0.unicode,
_1893: x0 => x0.dotAll,
_1894: (x0,x1) => x0.lastIndex = x1,
_1896: (o, p) => o[p],
_14540: () => globalThis.window,
_14561: x0 => x0.matches,
_14565: x0 => x0.platform,
_14570: x0 => x0.navigator,
_14577: x0 => x0.status,
_14578: (x0,x1) => x0.responseType = x1,
_14580: x0 => x0.response,
_14584: () => globalThis.window.flutterCanvasKit
    };
